...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test_263.PetService");
    jdbcTemplate.execute("DELETE FROM test_263.PetOwner");
    jdbcTemplate.execute("DELETE FROM test_263.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM test_263.Manager");
    jdbcTemplate.execute("DELETE FROM test_263.Document");
    jdbcTemplate.execute("DELETE FROM test_263.Pet");
     jdbcTemplate.execute("DELETE FROM test_263.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM test_263.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM test_263.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM test_263.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM test_263.PetCareCenterPets");
